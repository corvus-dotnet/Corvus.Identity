// <copyright file="ReadResourceGroupsAsServiceIdentityWithPlainTokens.cs" company="Endjin Limited">
...
namespace Corvus.Identity.Examples.UsingPlainTokens
{
    ...
    /// <summary>
    /// A service that reads a list of resource groups from the ARM API, using the ambient service
    /// identity.
    /// </summary>
    public class ReadResourceGroupsAsServiceIdentityWithPlainTokens
    {
        ...
        /// </param>
        public ReadResourceGroupsAsServiceIdentityWithPlainTokens(
