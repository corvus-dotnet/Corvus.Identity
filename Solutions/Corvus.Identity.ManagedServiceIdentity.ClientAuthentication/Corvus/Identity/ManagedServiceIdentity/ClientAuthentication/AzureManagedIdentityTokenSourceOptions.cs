// <copyright file="AzureManagedIdentityTokenSourceOptions.cs" company="Endjin Limited">
...
{
    /// <summary>
    /// Configuration settings for <see cref="AzureManagedIdentityTokenSource"/>.
    /// </summary>
    public class AzureManagedIdentityTokenSourceOptions
    {
        /// <summary>
        ...
        /// </p>
        /// <code><![CDATA[
        /// services.AddAzureMsiBasedTokenSource(configurationRoot.Get<AzureMsiTokenSourceOptions>());
        /// ]]></code>
        /// <p>
        ...
        /// to create an instance of <see cref="AzureManagedIdentityTokenSourceOptions"/> however you like. The
